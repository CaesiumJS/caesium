...
process.addBundleTransforms = true
process.bundleModules = []
process.bundleTransforms = []
process.bundleExtensions = []
process.writeQueue = []
...
Caesium.prototype.getSiteModule = function(){
  ...
  this.modules.loadFromSiteModule(this.siteModule)
...
Caesium.prototype.buildPaths = function(){
  ...
  return this.sourceMap.iterate(function(fileObject, res, rej){
    if(fileObject.frontMatter.module){
      mod = cae.modules.getModuleByName(fileObject.frontMatter.module)
    }else{
