...
module.exports = React.createClass({
  ...
  render: function(){
    ...
    headTags = []
    if(caesiumClient.siteModule.headTags.style){
    ...
    scriptTags = []
    if(caesiumClient.siteModule.headTags.script){
      caesiumClient.siteModule.headTags.script.forEach(function(script){
        scriptTags.push(React.DOM.script({src: script}))
      })
    }
